...
The installer defaults to a patched copy of disc 1's `images/boot.img` boot floppy with kickstart arguments added to `syslinux.cfg`. To boot from disc 1's original ISO boot path for manual debugging:
